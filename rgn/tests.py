...
from config import GeomNetConfig
...
c_train_template = GeomNetConfig(config={'checkpointsDirectory':  checkpoints_dir,
...
class CanonicalTest(tf.test.TestCase):
    ...
    def _createModel(self, c_train, c_evals):
        m_train = GeomNetModel('training', c_train)
        m_evals = []
        for c_eval in c_evals: m_evals.append(GeomNetModel('evaluation', c_eval))
    ...
    #     # values sourced from autograd
    #     self._testCore(c_train, [c_eval_wt_val], w, {'all/loss': [[2518.6995], [3579.6421], [7564.6065], [4977.0184]]})
    ...
    #     # not sourced from anywhere else. just used as a baseline for the future
    #     # numbers were computed on CPUs. GPUs (Pascal / Titan) will fail on this due to numerical drift.
    #     train_files = ['1', '2', '3']
    #     eval_files  = ['1']
    #     train_dir = base_dir + 'data/unofficial/tfrecord/training_long_with_subgroups/'
    #     eval_dir  = base_dir + 'data/unofficial/tfrecord/test_long_with_subgroups/'
    ...
    #     self._testCore(c_train, [c_eval], w, {'all/loss': [[7880.9792], [29750.760], [18070.761]],
    #                                           '10/loss':  [[6459.5146], [24827.776], [14950.578]],
    #                                           '20/loss':  [[6471.5256], [25111.795], [15086.717]],
    #                                           '30/loss':  [[6830.0896], [26415.604], [15928.435]],
    #                                           '40/loss':  [[6307.8617], [24708.496], [14857.236]],
    #                                           '50/loss':  [[8145.8519], [30373.419], [18516.966]],
    #                                           '70/loss':  [[9246.6843], [34484.085], [21057.387]],
    #                                           '90/loss':  [[9422.6669], [34687.637], [21230.548]]})
    ...
    #     # numbers were computed on CPUs. GPUs (Pascal / Maxwell) will fail on this due to numerical drift.
    #     train_dir = base_dir + 'data/CASP11Thinning30TwoResidueShiftEvoUniParcBakerJackHMMERNeg10JackHMMERNeg10/training/full/'
    #     eval_dir = base_dir + 'data/CASP11Thinning30TwoResidueShiftEvoUniParcBakerJackHMMERNeg10JackHMMERNeg10/validation/sample/'
    #     train_files = ['1', '2', '3']
    #     eval_files = ['1']
...
class IdiosyncraticTest(tf.test.TestCase):
    ...
    #         m_train = GeomNetModel('training', c_train_template)
    #         m_eval = GeomNetModel('evaluation', c_eval_template)
    ...
    #         m_train = GeomNetModel('training', c_train)
    #         m_eval_wt_val = GeomNetModel('evaluation', c_eval_wt_val)
    ...
    #     # This currently fails in the test file (on TF 1.12), but works fine in jupyter / actual code. Works fine everywhere on TF 1.4.
    #     with self.test_session(use_gpu=use_gpu) as sess:
    #         c_train = deepcopy(c_train_template)
    ...
    #     with self.test_session(use_gpu=use_gpu) as sess:    
    #         c_train = GeomNetConfig(config={'checkpointsDirectory': checkpoints_dir,
    #                                         'logModelSummaries':    False,
    #                                         'recurrentSize':        [state_size],
    #                                         'batchSize':            train_batch_size,
    #                                         'maxSeqLength':         max_seq_length,
    ...
    #         m_train = GeomNetModel('training', c_train)
    #         m_eval = GeomNetModel('evaluation', c_eval)
    ...
    #         m_unwt_eval = GeomNetModel('evaluation', c_unwt_eval)
